...
\begin{defin}
  Let $\theta \in \R_{>0}$ and $n \in \N$. A \textbf{discrete path} ($\theta$-path) is a map $Z: \R \supseteq [n] \to X$ that is $\theta$-lipschitz, i.e. for $\forall n_1, n_2 \in [n]$:
  \begin{equation}
...
% TODO: look up proper definition in BCW14
...
% Look in BCW14 for the equivalence relation needed to invert lazification and xyx situations
\begin{defin}
